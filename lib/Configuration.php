...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://game.prepaid-host.com/api/application';
    ...
    {
        $report  = 'PHP SDK (Pelican\Client) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://game.prepaid-host.com/api/application",
