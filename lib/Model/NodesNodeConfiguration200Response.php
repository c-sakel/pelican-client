 ...
 */
class NodesNodeConfiguration200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'nodes_nodeConfiguration_200_response';
    ...
    protected static $setters = [
        ...
        'api' => 'setApi',
        'system' => 'setSystem',
        'allowed_mounts' => 'setAllowedMounts',
        'remote' => 'setRemote'
    ];
    ...
    protected static $getters = [
        ...
        'api' => 'getApi',
        'system' => 'getSystem',
        'allowed_mounts' => 'getAllowedMounts',
        'remote' => 'getRemote'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('allowed_mounts', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['allowed_mounts'] === null) {
            $invalidProperties[] = "'allowed_mounts' can't be null";
        }
     ...
     * @return string
     */
    public function getAllowedMounts()
    {
        return $this->container['allowed_mounts'];
    }

    /**
     * Sets allowed_mounts
     *
     * @param string $allowed_mounts allowed_mounts
     *
     * @return self
     */
    public function setAllowedMounts($allowed_mounts)
    {
        if (is_null($allowed_mounts)) {
            throw new \InvalidArgumentException('non-nullable allowed_mounts cannot be null');
        }
        $this->container['allowed_mounts'] = $allowed_mounts;
