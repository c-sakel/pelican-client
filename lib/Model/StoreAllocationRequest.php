...
/**
 * StoreAllocationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StoreAllocationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreAllocationRequest';
    ...
    */
    ...
    public function setAlias($alias)
    {
        ...
        if (!is_null($alias) && (mb_strlen($alias) > 255)) {
            throw new \InvalidArgumentException('invalid length for $alias when calling StoreAllocationRequest., must be smaller than or equal to 255.');
        }
