...
/**
 * StoreDatabaseHostRequest Class Doc Comment
 *
 * @category Class
 * @package  Pelican\Client
 * @author   OpenAPI Generator team
 ...
 */
class StoreDatabaseHostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreDatabaseHostRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StoreDatabaseHostRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling StoreDatabaseHostRequest., must be smaller than or equal to 65535.');
        }
        if (($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling StoreDatabaseHostRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 32)) {
            throw new \InvalidArgumentException('invalid length for $username when calling StoreDatabaseHostRequest., must be smaller than or equal to 32.');
        }
     ...
     * Sets node_ids
     *
     * @param string[]|null $node_ids node_ids
     *
     * @return self
     */
    ...
    {
        if (is_null($node_ids)) {
            array_push($this->openAPINullablesSetToNull, 'node_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('node_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
