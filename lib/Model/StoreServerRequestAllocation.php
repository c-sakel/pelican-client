...
/**
 * StoreServerRequestAllocation Class Doc Comment
 *
 * @category Class
 * @package  Pelican\Client
 * @author   OpenAPI Generator team
 ...
 */
class StoreServerRequestAllocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreServerRequest_allocation';
    ...
    */
     ...
     * Sets default
     *
     * @param string|null $default Placeholders for rules added in withValidator() function.
     *
     * @return self
     */
