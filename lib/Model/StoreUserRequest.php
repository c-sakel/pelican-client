...
/**
 * StoreUserRequest Class Doc Comment
 *
 * @category Class
 * @package  Pelican\Client
 * @author   OpenAPI Generator team
 ...
 */
class StoreUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreUserRequest';
    ...
    public const TIMEZONE_AMERICA_COYHAIQUE = 'America/Coyhaique';
    ...
    public function getTimezoneAllowableValues()
    {
        return [
            ...
            self::TIMEZONE_AMERICA_COYHAIQUE,
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling StoreUserRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling StoreUserRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setExternalId($external_id)
    {
        ...
        if (!is_null($external_id) && (mb_strlen($external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling StoreUserRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 255)) {
            throw new \InvalidArgumentException('invalid length for $username when calling StoreUserRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling StoreUserRequest., must be bigger than or equal to 1.');
        }
